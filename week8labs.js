...
let myGreeting = new Greeting("Diane", "NE");
...
let yourBook = new Book("Le compte de Monte Cristo", "Alexandre Dumas");

console.log(yourBook.describe());

//console.log(`${yourBook.title} was written by ${yourBook.author}.`);
...
// below was my solution before watching solutions in video
...
class List {
  ...
  displayMovies() {
    ...
    for (let i = 0; i < this.movies.length; i++) {
      moviei += `${this.movies[i].title}, ${this.movies[i].director}\n`;
    }
    return moviei;
  }
}
